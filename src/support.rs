...
/// We are using an extremely simplified header
/// which only contains the current block number.
/// On real blockchain, you would expect to also find:
/// - parent block hash
/// - state root
/// - extrinsics root
/// - etc...
...
/// This is an "extrinsic": literally an external message
/// from outside of the blockchain.
/// This simplified version of an extrinsic tells us
/// who is making the call, and which call they are making.
