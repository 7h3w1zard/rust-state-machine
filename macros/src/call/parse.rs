...
/// This object will collect all the information we need to keep
/// while parsing the callable functions.
#[derive(Debug)]
pub struct CallDef {
	/// This is the name of the pallet struct where the callable
    /// functions are implemented. We mostly assume it is `Pallet`.
